...
case class SingleBatchProcess(m:Model,
  ...
  override def mapInfo: Map[String, Double] = Map("Performed batches" -> performedBatches,
...
case class BatchProcess(m:Model,
  ...
  override def mapInfo: Map[String, Double] = Map("Lines" -> numberOfBatches,
...
case class SplittingSingleBatchProcess(m:Model,
  ...
  var performedBatches = 0
  var startedBatches = 0
  private var completedBatches:Array[Int]= Array.fill(outputs.length)(0)
  ...
  override def mapInfo: Map[String, Double] = {
...
class ConveyorBeltProcess(m:Model,
  ...
  override def mapInfo: Map[String, Double] = Map("Content" -> belt.size,
