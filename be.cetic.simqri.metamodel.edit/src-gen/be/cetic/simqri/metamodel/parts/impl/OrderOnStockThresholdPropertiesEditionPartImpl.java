 ...
 * 
 */
public class OrderOnStockThresholdPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OrderOnStockThresholdPropertiesEditionPart {
	 ...
	 * 
	 */
	public OrderOnStockThresholdPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(orderOnStockThresholdStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == MetamodelViewsRepository.OrderOnStockThreshold.Properties.threshold) {
					return createThresholdText(parent);
				}
	...
	protected Composite createPeriodText(Composite parent) {
		...
		period.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrderOnStockThresholdPropertiesEditionPartImpl.this, MetamodelViewsRepository.OrderOnStockThreshold.Properties.period, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, period.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.OrderOnStockThreshold.Properties.period, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createThresholdText(Composite parent) {
		...
		threshold = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		threshold.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrderOnStockThresholdPropertiesEditionPartImpl.this, MetamodelViewsRepository.OrderOnStockThreshold.Properties.threshold, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, threshold.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.OrderOnStockThreshold.Properties.threshold, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrderOnStockThresholdPropertiesEditionPartImpl.this, MetamodelViewsRepository.OrderOnStockThreshold.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.OrderOnStockThreshold.Properties.name, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOrderQuantityText(Composite parent) {
		...
		orderQuantity = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		orderQuantity.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrderOnStockThresholdPropertiesEditionPartImpl.this, MetamodelViewsRepository.OrderOnStockThreshold.Properties.orderQuantity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, orderQuantity.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.OrderOnStockThreshold.Properties.orderQuantity, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOrderTypeEMFComboViewer(Composite parent) {
		...
		orderType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrderOnStockThresholdPropertiesEditionPartImpl.this, MetamodelViewsRepository.OrderOnStockThreshold.Properties.orderType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOrderType()));
			}

		});
		orderType.setID(MetamodelViewsRepository.OrderOnStockThreshold.Properties.orderType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.OrderOnStockThreshold.Properties.orderType, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createStorageFlatComboViewer(Composite parent) {
		...
		storage = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MetamodelViewsRepository.OrderOnStockThreshold.Properties.storage, MetamodelViewsRepository.SWT_KIND));
		...
		storage.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrderOnStockThresholdPropertiesEditionPartImpl.this, MetamodelViewsRepository.OrderOnStockThreshold.Properties.storage, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getStorage()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.OrderOnStockThreshold.Properties.storage, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createSupplierFlatComboViewer(Composite parent) {
		...
		supplier = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MetamodelViewsRepository.OrderOnStockThreshold.Properties.supplier, MetamodelViewsRepository.SWT_KIND));
		...
		supplier.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrderOnStockThresholdPropertiesEditionPartImpl.this, MetamodelViewsRepository.OrderOnStockThreshold.Properties.supplier, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSupplier()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.OrderOnStockThreshold.Properties.supplier, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
