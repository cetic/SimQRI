 ...
 * 
 */
public class FDistributionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, FDistributionPropertiesEditionPart {
	 ...
	 * 
	 */
	public FDistributionPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(MetamodelMessages.FDistributionPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createFreedomDegreeAText(Composite parent) {
		...
		freedomDegreeA.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FDistributionPropertiesEditionPartImpl.this, MetamodelViewsRepository.FDistribution.Properties.freedomDegreeA, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, freedomDegreeA.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.FDistribution.Properties.freedomDegreeA, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFreedomDegreeBText(Composite parent) {
		...
		freedomDegreeB.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FDistributionPropertiesEditionPartImpl.this, MetamodelViewsRepository.FDistribution.Properties.freedomDegreeB, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, freedomDegreeB.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.FDistribution.Properties.freedomDegreeB, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
