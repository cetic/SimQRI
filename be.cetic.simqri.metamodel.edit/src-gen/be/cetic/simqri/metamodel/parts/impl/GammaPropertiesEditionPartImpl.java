 ...
 * 
 */
public class GammaPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, GammaPropertiesEditionPart {
	 ...
	 * 
	 */
	public GammaPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(MetamodelMessages.GammaPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createShapeText(Composite parent) {
		...
		shape.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GammaPropertiesEditionPartImpl.this, MetamodelViewsRepository.Gamma.Properties.shape, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, shape.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.Gamma.Properties.shape, MetamodelViewsRepository.SWT_KIND), null); //$NON-NLS-1$
