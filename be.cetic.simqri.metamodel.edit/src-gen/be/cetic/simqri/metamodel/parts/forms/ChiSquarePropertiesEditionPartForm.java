 ...
 * 
 */
public class ChiSquarePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ChiSquarePropertiesEditionPart {
	 ...
	 */
	public ChiSquarePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ChiSquarePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(MetamodelMessages.ChiSquarePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createDegreeOfFreedomText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ChiSquarePropertiesEditionPartForm.this,
		...
		degreeOfFreedom.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ChiSquarePropertiesEditionPartForm.this, MetamodelViewsRepository.ChiSquare.Properties.degreeOfFreedom, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, degreeOfFreedom.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.ChiSquare.Properties.degreeOfFreedom, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
