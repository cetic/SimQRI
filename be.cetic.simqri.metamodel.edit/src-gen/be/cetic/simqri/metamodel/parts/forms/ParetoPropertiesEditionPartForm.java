 ...
 * 
 */
public class ParetoPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ParetoPropertiesEditionPart {
	 ...
	 */
	public ParetoPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ParetoPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(MetamodelMessages.ParetoPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createShapeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ParetoPropertiesEditionPartForm.this,
							MetamodelViewsRepository.Pareto.Properties.shape,
		...
		shape.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParetoPropertiesEditionPartForm.this, MetamodelViewsRepository.Pareto.Properties.shape, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, shape.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.Pareto.Properties.shape, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createScaleText(FormToolkit widgetFactory, Composite parent) {
		...
		scale.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ParetoPropertiesEditionPartForm.this,
							MetamodelViewsRepository.Pareto.Properties.scale,
		...
		scale.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ParetoPropertiesEditionPartForm.this, MetamodelViewsRepository.Pareto.Properties.scale, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, scale.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.Pareto.Properties.scale, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
