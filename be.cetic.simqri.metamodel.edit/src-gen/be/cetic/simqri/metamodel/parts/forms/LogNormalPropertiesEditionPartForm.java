 ...
 * 
 */
public class LogNormalPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, LogNormalPropertiesEditionPart {
	 ...
	 */
	public LogNormalPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public LogNormalPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createLocationText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							LogNormalPropertiesEditionPartForm.this,
							MetamodelViewsRepository.LogNormal.Properties.location,
		...
		location.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogNormalPropertiesEditionPartForm.this, MetamodelViewsRepository.LogNormal.Properties.location, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, location.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.LogNormal.Properties.location, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createScaleText(FormToolkit widgetFactory, Composite parent) {
		...
		scale.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							LogNormalPropertiesEditionPartForm.this,
							MetamodelViewsRepository.LogNormal.Properties.scale,
		...
		scale.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogNormalPropertiesEditionPartForm.this, MetamodelViewsRepository.LogNormal.Properties.scale, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, scale.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.LogNormal.Properties.scale, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
