 ...
 * 
 */
public class PoissonPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, PoissonPropertiesEditionPart {
	 ...
	 */
	public PoissonPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public PoissonPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createIntervalText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PoissonPropertiesEditionPartForm.this,
							MetamodelViewsRepository.Poisson.Properties.interval,
		...
		interval.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PoissonPropertiesEditionPartForm.this, MetamodelViewsRepository.Poisson.Properties.interval, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, interval.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.Poisson.Properties.interval, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
