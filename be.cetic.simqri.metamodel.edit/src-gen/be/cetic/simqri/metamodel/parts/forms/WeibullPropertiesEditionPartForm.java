 ...
 * 
 */
public class WeibullPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, WeibullPropertiesEditionPart {
	 ...
	 */
	public WeibullPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public WeibullPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(MetamodelMessages.WeibullPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createShapeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WeibullPropertiesEditionPartForm.this,
							MetamodelViewsRepository.Weibull.Properties.shape,
		...
		shape.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WeibullPropertiesEditionPartForm.this, MetamodelViewsRepository.Weibull.Properties.shape, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, shape.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.Weibull.Properties.shape, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createScaleText(FormToolkit widgetFactory, Composite parent) {
		...
		scale.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WeibullPropertiesEditionPartForm.this,
							MetamodelViewsRepository.Weibull.Properties.scale,
		...
		scale.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(WeibullPropertiesEditionPartForm.this, MetamodelViewsRepository.Weibull.Properties.scale, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, scale.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MetamodelViewsRepository.Weibull.Properties.scale, MetamodelViewsRepository.FORM_KIND), null); //$NON-NLS-1$
