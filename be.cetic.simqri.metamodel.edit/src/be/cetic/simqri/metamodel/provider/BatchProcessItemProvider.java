...
/**
 * This is the item provider adapter for a {@link be.cetic.simqri.metamodel.BatchProcess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BatchProcessItemProvider extends ProcessItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BatchProcessItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Percentage Of Success feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPercentageOfSuccessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BatchProcess_percentageOfSuccess_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BatchProcess_percentageOfSuccess_feature", "_UI_BatchProcess_type"),
				 MetamodelPackage.Literals.BATCH_PROCESS__PERCENTAGE_OF_SUCCESS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodelPackage.Literals.BATCH_PROCESS__OUTPUTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BatchProcess"));
	}
	...
	public String getText(Object object) {
		String label = ((BatchProcess)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BatchProcess_type") :
			getString("_UI_BatchProcess_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.BATCH_PROCESS__OUTPUTS,
				 MetamodelFactory.eINSTANCE.createOutput()));
	}
