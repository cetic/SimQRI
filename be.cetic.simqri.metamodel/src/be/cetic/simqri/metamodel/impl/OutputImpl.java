 ...
 * </p>
 * <ul>
 *   <li>{@link be.cetic.simqri.metamodel.impl.OutputImpl#getType <em>Type</em>}</li>
 *   <li>{@link be.cetic.simqri.metamodel.impl.OutputImpl#getProcessOutputFlow <em>Process Output Flow</em>}</li>
 *   <li>{@link be.cetic.simqri.metamodel.impl.OutputImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputImpl extends MinimalEObjectImpl.Container implements Output {
	...
	public void setType(OutputType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.OUTPUT__TYPE, oldType, type));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.OUTPUT__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MetamodelPackage.OUTPUT__PROCESS_OUTPUT_FLOW:
