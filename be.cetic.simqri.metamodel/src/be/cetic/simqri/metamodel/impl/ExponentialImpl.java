 ...
 * </p>
 * <ul>
 *   <li>{@link be.cetic.simqri.metamodel.impl.ExponentialImpl#getScale <em>Scale</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExponentialImpl extends DistributionImpl implements Exponential {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.EXPONENTIAL;
	}
	...
	public void setScale(Double newScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.EXPONENTIAL__SCALE, oldScale, scale));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.EXPONENTIAL__SCALE:
				return getScale();
		}
