 ...
 * </p>
 * <ul>
 *   <li>{@link be.cetic.simqri.metamodel.impl.GammaImpl#getShape <em>Shape</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GammaImpl extends DistributionImpl implements Gamma {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.GAMMA;
	}
	...
	public void setShape(Double newShape) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.GAMMA__SHAPE, oldShape, shape));
	}
