 ...
 * </p>
 * <ul>
 *   <li>{@link be.cetic.simqri.metamodel.impl.PoissonImpl#getInterval <em>Interval</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PoissonImpl extends DistributionImpl implements Poisson {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.POISSON;
	}
	...
	public void setInterval(Double newInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.POISSON__INTERVAL, oldInterval, interval));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.POISSON__INTERVAL:
				return getInterval();
		}
